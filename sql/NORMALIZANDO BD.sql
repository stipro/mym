...
ALTER TABLE `productos` ADD CONSTRAINT `fk_id_categoria_producto` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id_categoria`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `productos` ADD CONSTRAINT `fk_id_proveedor_producto` FOREIGN KEY (`id_proveedor`) REFERENCES `provedores` (`id_proveedor`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `salidas` ADD CONSTRAINT `fk_id_producto_salida` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `entradas` ADD CONSTRAINT `fk_id_producto_entrada` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_proveedor`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `productos` ADD CONSTRAINT `fk_id_marca_producto` FOREIGN KEY (`id_marca`) REFERENCES `marcas` (`id_marca`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `unidades_medida` ADD CONSTRAINT `fk_id_producto_uniMedida` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `almacenes_productos` ADD CONSTRAINT `fk_id_producto_almacen` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `requerimientos` ADD CONSTRAINT `fk_id_producto_requerimiento` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
...
`comisiones_live`.`productos`.`codigo_producto`,
`comisiones_live`.`productos`.`nombre_producto`,
`comisiones_live`.`productos`.`precio_producto`,
...
INNER JOIN `comisiones_live`.`productos` ON `comisiones_live`.`productos`.`id_almacen` = `comisiones_live`.`almacenes`.`id_almacen`
INNER JOIN `comisiones_live`.`entradas` ON `comisiones_live`.`entradas`.`id_producto` = `comisiones_live`.`productos`.`id_proveedor`
INNER JOIN `comisiones_live`.`salidas` ON `comisiones_live`.`salidas`.`id_producto` = `comisiones_live`.`productos`.`id_producto`
WHERE
`comisiones_live`.`almacenes`.`id_almacen` = `comisiones_live`.`productos`.`id_almacen` AND
`comisiones_live`.`entradas`.`id_producto` = `comisiones_live`.`productos`.`id_producto` AND
`comisiones_live`.`salidas`.`id_producto` = `comisiones_live`.`productos`.`id_producto`
HAVING;

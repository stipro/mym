...
<head>
    ...
    <link href="..\..\libs\nifty\css\bootstrap.min.css" rel="stylesheet">
    ...
    <link href="..\..\libs\nifty\plugins\pace\pace.min.css" rel="stylesheet">
    <script src="..\..\libs\nifty\plugins\pace\pace.min.js"></script>
    ...
    <!--FooTable [ OPTIONAL ]-->
    <link href="..\..\libs\nifty\plugins\fooTable\css\footable.core.css" rel="stylesheet">
...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Inventario</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->                </div>
                ...
                <div id="page-content">
					        ...
					        <div class="panel">
					            ...
					            <div class="panel-body">
					                <table id="demo-foo-pagination" class="table toggle-circle" data-page-size="5">
					                    <thead>
					                        <tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 text-xs-center">
                                                    <div class="form-group">
                                                        <button id="" class="btn btn-purple"><i class="demo-pli-plus"></i> Agregar nueva Almacen</button>
                                                        <!-- Paginacion -->
					                    ...
					                    <tbody>
					                        <tr>
					                            <td>Sistema</td>
					                            <td>Almacen del Area de sistemna</td>
					                        ...
					                        <tr>
					                            <td>Recepción</td>
					                            <td>Almacen de Recepxión</td>
					                            <td>Airline Transport Pilot</td>
					                            <td>3 Oct 1981</td>
					                            <td><span class="label label-table label-dark">Desactivado</span></td>
					                        </tr>
					                        <tr>
					                            <td>Martinetti</td>
					                            <td>Almacen de Martinetti</td>
					                            <td>Business Services Sales Representative</td>
					                            <td>19 Apr 1969</td>
					                            <td><span class="label label-table label-danger">Suspendido</span></td>
					                        </tr>
					                        <tr>
					                            <td>Cural - Garita</td>
					                            <td>Almacen de Garita</td>
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        <div class="pad-btm">
                                            <img class="img-circle img-md" src="..\..\libs\nifty\img\profile-photos\1.png" alt="Profile Picture">
                                        </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li><a href="forms-general.html">Inicio</a></li>
											<li><a href="forms-components.html">Productos</a></li>
                                            <li><a href="forms-validation.html">Proveedores</a></li>
                                            <li><a href="forms-validation.html">Almacenes</a></li>
                                        </ul>
						            </li>
						            ...
						            <li>
						                ...
						                <ul class="collapse">
											...
											<li class="active-link"><a href="tables-footable.html">Foo Tables</a></li>
                                ...
                                <div class="mainnav-widget">
                                    ...
                                    <div id="demo-wg-server" class="hide-small mainnav-widget-content">
                                        <ul class="list-group">
                                            <li class="list-header pad-no mar-ver">El estado del servidor</li>
                                            <li class="mar-btm">
    ...
    <!--jQuery [ REQUIRED ]-->
    <script src="..\..\libs\nifty\js\jquery.min.js"></script>


    <!--BootstrapJS [ RECOMMENDED ]-->
    <script src="..\..\libs\nifty\js\bootstrap.min.js"></script>
    ...
    <!--FooTable [ OPTIONAL ]-->
    <script src="..\..\libs\nifty\plugins\fooTable\dist\footable.all.min.js"></script>


    <!--FooTable Example [ SAMPLE ]-->
    <script src="..\..\libs\nifty\js\demo\tables-footable.js"></script>
